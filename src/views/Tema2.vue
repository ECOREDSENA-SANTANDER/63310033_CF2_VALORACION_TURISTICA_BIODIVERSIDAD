...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        .bg6.p-4
          .row.justify-content-center.align-items-center.mb-0
            .col
              img.mb-0.img-a.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/2.svg')
            .col-lg-11
    ...
    .row.fondo4.justify-content-center.align-items-center.p-2.mb-0(data-aos="fade-down")
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-8.mb-4
        ul.lista-ul
          li.d-flex.mb-3
            i.fas.fa-leaf
            p.mb-0 Las normas legales.
          .hr3.mb-3
          li.d-flex.mb-3
            i.fas.fa-leaf
            p.mb-0 Los planes de manejo y ordenamiento.
          .hr3.mb-3
          li.d-flex.mb-3
            i.fas.fa-leaf
            p.mb-0 Los instrumentos económicos y financieros.
          .hr3.mb-3
          li.d-flex.mb-3
            i.fas.fa-leaf
            p.mb-0 Las herramientas jurídicas para la conservación en tierras privadas.
          .hr3.mb-3
          li.d-flex.mb-3
            i.fas.fa-leaf
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9.mb-0
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--azul").mb-0(data-aos="fade-right")
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Sistema de Parques Nacionales Naturales")
            .col-lg-7.mb-4
              p.mb-0 Su declaración corresponde al Ministerio de Ambiente y Desarrollo Sostenible, mientras que su administración y manejo están a cargo de Parques Nacionales Naturales.
            .col-lg-5.col-md-7.mb-4
              img(src='@/assets/curso/tema2/10.png', alt='')
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Reservas Forestales Protectoras")
            .col-lg-7.mb-4
              p.mb-4 Espacios geográficos donde los ecosistemas boscosos mantienen su función ecológica, a pesar de modificaciones estructurales. Pueden ser de carácter público o privado y están destinadas al uso y manejo sostenible de bosques o coberturas vegetales.
              ul.lista-ul
                li.d-flex.mb-0
                  i.fas.fa-leaf
                  p.mb-0 #[b Nacionales:] si protegen ecosistemas estratégicos a escala nacional, las declara el ministerio y son administradas por las Corporaciones Autónomas Regionales (CAR).
                li.d-flex.mb-0
                  i.fas.fa-leaf
                  p.mb-0 #[b Regionales:] si el ecosistema es estratégico a nivel regional, son declaradas y administradas por las CAR.
            .col-lg-5.col-md-7.mb-4
              img(src='@/assets/curso/tema2/11.png', alt='')
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Parques Naturales Regionales")
            .col-lg-7.mb-4
              p.mb-0 Áreas que conservan paisajes y ecosistemas estratégicos regionales, incluyendo su estructura, composición y procesos ecológicos. Son destinadas a la preservación, restauración, conocimiento y disfrute. Su declaración y manejo son competencia de las CAR.
            .col-lg-5.col-md-7.mb-4
              img(src='@/assets/curso/tema2/12.png', alt='')
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Distritos de manejo integrado")
            .col-lg-7.mb-4
              p.mb-0 Áreas donde los ecosistemas conservan su función y composición, aunque su estructura haya sido modificada. Se orientan al uso sostenible, conservación, restauración y apropiación social del territorio.
              ul.lista-ul
                li.d-flex.mb-0
                  i.fas.fa-leaf
                  p.mb-0 #[b Nacionales:] declarados por el ministerio y administrados por parques nacionales o por delegación en otra autoridad ambiental.
                li.d-flex.mb-0
                  i.fas.fa-leaf
                  p.mb-0 #[b Regionales:] declarados y administrados por las CAR.
            .col-lg-5.col-md-7.mb-4
              img(src='@/assets/curso/tema2/13.png', alt='')
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Distritos de conservación de suelos")
            .col-lg-7.mb-4
              p.mb-0 Zonas con paisajes estratégicos regionales que, aunque alterados en su estructura y composición, siguen generando bienes y servicios ambientales clave. Su gestión corresponde a las CAR.
            .col-lg-5.col-md-7.mb-4
              img(src='@/assets/curso/tema2/14.png', alt='')
          .row.justify-content-center.align-items-center.col-xl-11.m-auto(titulo="Áreas de recreación")
            .col-lg-7.mb-4
              p.mb-0 Espacios regionales con ecosistemas funcionales pero modificados, con potencial de recuperación. Se orientan a la restauración, preservación, conocimiento y disfrute, bajo la administración de las CAR.
            .col-lg-5.col-md-7.mb-4
    ...
    .titulo.mb-5.ps-5.pe-3(data-aos="fade-right")
      img(src='@/assets/curso/tema1/titulo.png', alt='Imagen decorativa')
      h3.mb-0.text-white.mx-4 Áreas protegidas privadas
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        .bg6.p-4
          .row.justify-content-center.align-items-center.mb-0
            .col
              img.mb-0.img-a.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/16.svg')
            .col-lg-11
    ...
    .row.justify-content-center.align-items-center
      .col-lg-12
        .titulo-sexto.color-secundario.mb-4
          h5 Figura 4. 
          | Mapa geográfico del “Sistema de Parques Nacionales Naturales de Colombia”
      
    .row.fondo5.justify-content-center.align-items-center.p-2.mb-0(data-aos="fade-down")
      .col-lg-12.px-lg-5.px-4.mb-0
        
        .row.justify-content-center.align-items-center.mb-4.my-4
          .col-lg-9
            img.mb-4(src='@/assets/curso/tema2/17.jpg', alt='La figura representa un mapa geográfico del Sistema de Parques Nacionales Naturales de Colombia, en el que se identifican las ubicaciones de 59 áreas protegidas distribuidas a lo largo del territorio nacional. Estas áreas están asociadas a diferentes ecosistemas estratégicos, con el propósito de conservar la biodiversidad y los servicios ecosistémicos.')
            figcaption.mb-4 Fuente. https://runap.parquesnacionales.gov.co/
    

    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
      .col-lg-12
        .fondo6.p-lg-4.p-md-5.p-5
          .row.justify-content-center.align-items-center
            .col-lg-2
              img.mb-0.img-a.img-t.d-none.d-lg-block.mbt1(src='@/assets/curso/tema2/iz.png')
            .col-lg-8
              h3.mb-0.text-center.text-white 80 ecosistemas de 315 en el país están en los Parques Nacionales Naturales
            .col-lg-2
              img.mb-0.img-a.img-t.d-none.d-lg-block.mbt2(src='@/assets/curso/tema2/de.png')
            ...
            .bg1.p-3
              .row.justify-content-center.align-items-center.mb-0
                .col
                  img.mb-0.img-a.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/2.svg')
                .col-lg-10
                  p.mb-0 Al menos 40 pueblos indígenas y decenas de comunidades afrocolombianas utilizan los parques para garantizar la vida y el sostenimiento de sus culturas ancestrales. Se protegen espacios importantes para la tradición espiritual.
      .col-lg-5
    ...
    .bg16.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-7(data-aos="fade-left")
          .p-4
            .br2.mb-3
            p.mb-4(data-aos="fade-left") El Sistema de Parques Nacionales Naturales contribuye a mantener la salud de los ecosistemas, los cuales, a su vez, desempeñan un papel esencial en la protección y bienestar de la vida humana.
            p.mb-0 El buen estado de conservación de los ecosistemas contribuye significativamente a la prevención y mitigación de desastres naturales como tsunamis, inundaciones y avalanchas. Además, estos ecosistemas desempeñan un papel clave en la regulación climática, ayudando a mitigar los efectos del cambio climático en las regiones donde se encuentran.
    ...
    .row.justify-content-start.align-items-center.mb-5
      ...
      .col-lg-4
        .row.justify-content-start.align-items-center.mb-0
          .col-lg-3
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-8.mb-4
        ul.lista-ul
          li.d-flex.mb-2
            i.fas.fa-leaf
            p.mb-0 a) Parque Nacional Natural: área destinada a la conservación de ecosistemas representativos, con alta biodiversidad y escasa intervención humana, donde se permite la investigación, educación y ecoturismo bajo regulación estricta.
          .hr3.mb-2
          li.d-flex.mb-2
            i.fas.fa-leaf
            p.mb-0 b) Santuario de fauna y flora: zona que protege especies animales o vegetales en peligro, endémicas o de especial interés científico, garantizando su hábitat y condiciones naturales.
          .hr3.mb-2
          li.d-flex.mb-2
            i.fas.fa-leaf
            p.mb-0 c) Reserva natural: área que permite la conservación de recursos naturales renovables, combinada con usos sostenibles como investigación, educación ambiental y aprovechamiento controlado.
          .hr3.mb-2
          li.d-flex.mb-2
            i.fas.fa-leaf
        ...
        .col-lg-12
          .row.justify-content-center.align-items-center
            .col-lg-2
              img.mb-0.d-none.d-lg-block.tam(src='@/assets/curso/tema2/0.png')
            .col-lg-10
              p.mb-0 Cada una de estas categorías tiene objetivos específicos de conservación, regulación del uso y manejo, y responde a criterios ecológicos, científicos, culturales y recreativos definidos por la normatividad ambiental del país.
